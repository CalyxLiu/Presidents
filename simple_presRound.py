...
class presRound(object):
    ...
    def __init__(self, players, startingPlayer, pomdpPlayer, print):
        self.players = players
        self.pomdpPlayer = pomdpPlayer
    ...
    def nextPlayerStart(self):
        ...
        if self.pomdpPlayer != None:
            self.pomdpPlayer.updateNotHand(self.currentCards, self.currentPlayer.name)
        self.prevCards = []
